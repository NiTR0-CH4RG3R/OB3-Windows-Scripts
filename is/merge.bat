...
echo [INFO] Deleting org.wso2.carbon.identity.application.authentication.handler.identifier.-*.jar file
DEL "%WSO2_BASE_PRODUCT_HOME%\repository\components\dropins\org.wso2.carbon.identity.application.authentication.handler.identifier-*"
